...
public class L2AttackableAI extends L2CharacterAI implements Runnable {
  ...
  private boolean autoAttackCondition(L2Character target) {
    ...
    if(_actor instanceof L2GuardInstance) {
      ...
      return false;
    } else if(_actor instanceof L2FriendlyMobInstance) { // the actor is a L2FriendlyMobInstance
      ...
      return false;
    } else { // The actor is a L2MonsterInstance
      ...
      if(((L2NpcInstance) _actor).getFactionId() != null) {
        ...
        for(L2Object obj : _actor.getKnownList().getKnownObjects().values()) {
          if(obj instanceof L2NpcInstance) {
            ...
            if(_actor.isInsideRadius(npc, npc.getFactionRange(), true, false) && (Math.abs(getAttackTarget().getZ() - npc.getZ()) < 600) && (npc.getAI() != null) && _actor.getAttackByList().contains(getAttackTarget()) && ((npc.getAI()._intention == CtrlIntention.AI_INTENTION_IDLE) || (npc.getAI()._intention == CtrlIntention.AI_INTENTION_ACTIVE))) {
