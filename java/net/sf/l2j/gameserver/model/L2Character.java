...
public abstract class L2Character extends L2Object {
  ...
  protected void moveToLocation(int x, int y, int z, int offset) {
    ...
    if((Config.GEODATA > 0) && !isFlying()) // currently flying characters not checked
    {
      ...
      if(((Config.GEODATA == 2) && !((this instanceof L2Attackable) && ((L2Attackable) this).isReturningToSpawnPoint())) || (this instanceof L2PcInstance) || ((this instanceof L2Summon) && !(getAI().getIntention() == AI_INTENTION_FOLLOW))) {
        if(isOnGeodataPath()) {
      ...
      // If no distance to go through, the movement is canceled
      if((distance < 1) && ((Config.GEODATA == 2) || (this instanceof L2PlayableInstance))) {
        sin = 0;
        cos = 1;
        distance = 0;
        x = curX;
